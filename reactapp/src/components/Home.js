      ...
      <div>
            ...
            <Grid container spacing={5} alignItems="center">
              ...
              <Grid item xs={12} md={6}>
                ...
                <Typography variant="body1" paragraph>
                  Our company has been providing exceptional services for over a
                  decade. We specialize in offering top-notch solutions to meet
                  the diverse needs of our clients. Our team of experts is
                  dedicated to delivering innovative and effective strategies to
                  help businesses thrive.
                </Typography>
                <Typography variant="body1" paragraph>
                  Whether you're looking for customized solutions or expert
                  guidance, we're here to help you achieve your goals. Our
                  commitment to excellence is evident in everything we do, and
                  we're proud to be a trusted partner to many successful
                  businesses.
                </Typography>
                <Link to="/about">
                  <Button
        ...
        >
          <Container style={{ textAlign: "center" }} maxWidth="lg">
              ...
              {cardImages.map((card, index) => (
                <Grid item xs={12} sm={4} ms={4} key={index}>
                  <Card
                    ...
                    onMouseEnter={(e) => {
                      e.currentTarget.style.boxShadow='0px 0px 8px black'; // black boxShadow on hover
                    }}
                    onMouseLeave={(e) => {
            ...
            <Button variant="contained" size="medium" style={{ borderRadius: "0 10px 0 10px", marginBottom: "25px" }}>show more </Button>
            </Link>
          </Container>
        </div>
      </div>
